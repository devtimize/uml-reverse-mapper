...
import org.devtimize.urm.testdomain.observ.Observable;
import org.devtimize.urm.testdomain.observ.Observer;
import org.devtimize.urm.testdomain.weirdos.GenericMadness;
...
public class TypeUtilsTest {
    ...
    final String[] observableMembers = { "Observable<S extends Observable, O extends Observer<S, O, A>, A>",
            "void", "void", "void", "List<O extends Observer<S, O, A>>"
    };

    final String[] observerMembers = { "Observer<S extends Observable<S, O, A>, O extends Observer, A>", "void" };
